...
- [x] **#38 — Final audit of course-push CTAs** — swept 2026-04-20. Of 33 files with course-purchase references, 18 (Tier B learning + Tier C industry) swapped to `/claude-code-guide`. 15 kept (Tier A high-intent: 5 calculator pages, 3 calculator components, 5 audience prompt packs, `ConversionOptimizer` which fires post-calculator-result). **2026-04-21 follow-up:** `/best-ai-tools` CTA (general AI-tools CollectionPage, Tier B) swapped to `/claude-code-guide` — was a straggler flagged in HANDOFF-2026-04-20.
- [x] **Skills hub meta pages** — PR #13 merged 2026-04-21 (`d25b69b`). `/claude-code-skills/install-guide` and `/claude-code-skills/build-your-own` live; cross-links added from `/claude-code-mcp-stack`, `/claude-pro-vs-max-vs-api`, and `/calculators/claude-plan-picker`. Closes HANDOFF-2026-04-20 P1 #1 and P2 #4.
