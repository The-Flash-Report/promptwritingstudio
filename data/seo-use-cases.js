...
export const seoUseCases = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: 'Which AI tool is best for professional use?', answer: 'ChatGPT (GPT-4o) is the most versatile for general business tasks. Claude Sonnet 4.6 excels at long-form documents, detailed analysis, and coding. Gemini 2.0 Flash is ideal for research and Google Workspace integration. For most professionals, starting with GPT-4o and adding Claude Sonnet 4.6 for complex tasks provides the best coverage.' },
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: 'What AI platforms work with generated prompts?', answer: 'Generated prompts work with all major AI platforms including ChatGPT (GPT-4o, GPT-4.1), Claude, Google Gemini, Microsoft Copilot, Perplexity, and Llama-based models. The prompt engineering principles are universal across all large language models.' },
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: 'What is the best AI for writing blog posts?', answer: 'GPT-4o and Claude Sonnet 4.6 are the top choices for blog writing. ChatGPT excels at creative, conversational content. Claude handles long-form, detailed articles better and follows complex formatting instructions more reliably. Gemini is strong for research-heavy posts that need current information.' },
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: 'Is prompt engineering still relevant with newer AI models?', answer: 'Yes. Newer models like GPT-4o, Claude Sonnet 4.6, and Gemini 2.0 Flash are more capable but still benefit significantly from well-structured prompts. The techniques shift slightly — newer models require less explicit hand-holding for basic tasks — but role prompting, few-shot examples, format specification, and constraint setting all still produce measurably better results. The highest-impact techniques remain consistent across model generations.' },
  ...
  },
  {
    ...
    description: 'Copy 50+ tested Claude prompts for writing, analysis, coding, and research. Includes tips for Claude Sonnet 4.6 and Opus 4.6 — and what makes Claude different from ChatGPT.',
    h1: 'Claude Prompts',
    intro: 'Claude (by Anthropic) is increasingly the preferred AI tool for tasks requiring nuanced instruction-following, careful analysis, and long-document work. Claude Sonnet 4.6 leads benchmarks for coding, and Claude responds especially well to detailed constraint lists — making it ideal for tasks where the exact format and tone of the output matter.\n\nThese prompts are designed for Claude\'s strengths: careful reasoning, document analysis, writing with a specific voice, and tasks that benefit from explicit constraints. They work on Claude.ai and via the Anthropic API.',
    ...
    examplePrompts: [
      ...
      },
      {
        ...
        description: 'Claude Sonnet 4.6 is currently the leading model for code review.',
