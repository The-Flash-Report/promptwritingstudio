...
import hrManagersData from '../../data/modifiers/hr-managers.json'

export default function HRManagersPage() {
  const pageSchema = {
    "@context": "https://schema.org",
    "@type": "WebPage",
    "name": hrManagersData.seoData.title,
    "description": hrManagersData.seoData.description,
    "url": "https://promptwritingstudio.com/prompts/hr-managers",
    "breadcrumb": {
      "@type": "BreadcrumbList",
      "itemListElement": [
        {
        ...
        },
        {
          ...
          "position": 3,
          "name": "HR Managers",
          "item": "https://promptwritingstudio.com/prompts/hr-managers"
        }
      ]
    }
  }
  ...
  return (
    <>
      <Head>
        <title>{hrManagersData.seoData.title}</title>
        <meta name="description" content={hrManagersData.seoData.description} />
        <meta name="keywords" content={hrManagersData.seoData.keywords} />
        
        {/* Open Graph */}
        <meta property="og:title" content={hrManagersData.seoData.title} />
        <meta property="og:description" content={hrManagersData.seoData.description} />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://promptwritingstudio.com/prompts/hr-managers" />
        
        {/* Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={hrManagersData.seoData.title} />
        <meta name="twitter:description" content={hrManagersData.seoData.description} />
        
        {/* Canonical URL */}
        <link rel="canonical" href="https://promptwritingstudio.com/prompts/hr-managers" />
      ...
      <Layout>
        ...
        <section className="py-16 bg-white">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">
              Why HR Managers Choose AI Prompts
            </h2>
            <div className="grid md:grid-cols-3 gap-8">
              {hrManagersData.benefits.map((benefit, index) => (
        ...
        <section id="prompts" className="py-16 bg-gray-50">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">
              HR Management AI Prompts
            </h2>
            
            <div className="grid gap-8">
              {hrManagersData.promptCategories.map((category, index) => (
        ...
        <section className="py-16 bg-white">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {hrManagersData.useCases.map((useCase, index) => (
        ...
        <section className="py-16 bg-gray-50">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-6">
              {hrManagersData.faqs.map((faq, index) => (
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Link href="/prompts/marketing-professionals" className="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition group">
                ...
                <h3 className="text-lg font-semibold mb-2 group-hover:text-green-600">Marketing Professionals</h3>
              ...
              <Link href="/prompts/sales-teams" className="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition group">
                <div className="text-2xl mb-3">📞</div>
                <h3 className="text-lg font-semibold mb-2 group-hover:text-green-600">Sales Teams</h3>
              ...
              <Link href="/prompts/small-business-owners" className="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition group">
                <div className="text-2xl mb-3">🏪</div>
                <h3 className="text-lg font-semibold mb-2 group-hover:text-green-600">Small Business Owners</h3>
        ...
        <section className="py-16 bg-green-600">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-green-100 mb-8">
              Join HR managers who've automated recruitment, performance reviews, and employee communications with AI
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
