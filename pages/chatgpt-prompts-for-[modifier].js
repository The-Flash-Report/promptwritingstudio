      ...
      <section className="gradient-bg text-white py-16 md:py-24">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <a href="#prompt-templates" className="bg-[#FFDE59] text-black px-8 py-3 rounded-lg font-bold hover:bg-[#E5C84F] transition inline-block">
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link 
                href="/#pricing" 
                className="bg-[#FFDE59] text-black px-8 py-3 rounded-lg font-bold hover:bg-[#E5C84F] transition"
              >
                View Pricing Plans
              </Link>
              <Link 
                href="/chatgpt-prompt-templates" 
                className="border border-white text-white px-8 py-3 rounded-lg font-bold hover:bg-[#FFDE59] hover:text-black hover:border-[#FFDE59] transition"
              >
